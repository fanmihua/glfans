...
[[ "$full_mode" == 0 || "$full_mode" == 1 ]] || { printf 'GLFANS_FULL_MODE must be 0 or 1.\n' >&2; exit 1; }
...
ssh "${ssh_options[@]}" "$remote" "GLFANS_SITE_ROOT='$site_root' GLFANS_RELEASE_ID='$release_id' GLFANS_FILING_MODE='$filing_mode' GLFANS_FULL_MODE='$full_mode' bash '$stage/deploy-static-vps.sh' '$stage/client'"
