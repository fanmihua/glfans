...
import { ArrowRight, CalendarBlank, MagnifyingGlass, X } from '@phosphor-icons/react';
...
import { archiveSearchQueryReady, archiveSearchResults } from './features/archive/archive-search.js';
import { cpCopy } from './features/cp/cp-copy.js';
import { cpProfiles } from './features/cp/cp-runtime-data.js';
...
function ArchiveOverview({ onOpenCalendar }) {
  ...
  const searchResults = useMemo(() => archiveSearchResults(search, archiveDramas, cpProfiles), [search]);
      ...
      <section className="archive-stage" aria-labelledby="archive-title">
        ...
        <header className="archive-masthead">
          ...
          <div className="archive-actions">
            ...
            {searchPanelPosition && createPortal(<div ref={searchPanelRef} id="archive-search-results" className="archive-search-results" aria-label={searchCopy.resultLabel} style={searchPanelPosition}>
