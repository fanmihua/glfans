...
const aboutCopy = {
  zh: {
    intro: 'glfans 是由粉丝维护的非官方、非商业泰百影视资料站。考古档案按年份整理剧集；播出日历汇总已公布的排期；百家饭记录演员公开资料、共同作品与职业经历。',
    sections: '考古档案 · 播出日历 · 百家饭',
    heading: '公开资料索引',
  ...
  en: {
    intro: 'glfans is an unofficial, non-commercial archive maintained by fans of Thai GL series. The series archive organizes works by year, the airing calendar lists announced schedules, and the CP archive collects public actor profiles, shared works and career histories.',
    sections: 'Series · Calendar · CPs',
  ...
  th: {
    intro: 'glfans เป็นคลังข้อมูลซีรีส์ GL ไทยที่แฟน ๆ ดูแลอย่างไม่เป็นทางการและไม่แสวงหากำไร คลังซีรีส์จัดเรียงผลงานตามปี ปฏิทินออกอากาศรวบรวมกำหนดการที่ประกาศแล้ว และคลังคู่รวบรวมข้อมูลสาธารณะของนักแสดง ผลงานร่วมกัน และเส้นทางการทำงาน',
    sections: 'ซีรีส์ · ปฏิทิน · คู่นักแสดง',
